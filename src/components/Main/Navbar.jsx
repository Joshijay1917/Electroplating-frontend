...
const Navbar = ({ toggleDarkMode, darkmode }) => {
    return (
        <div className="nav px-3 bg-gray-200 dark:bg-gray-500 text-gray-700 dark:text-white rounded-b-4xl top-0 flex text-3xl w-full justify-between items-center">
