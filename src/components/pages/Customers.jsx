  ...
  return (
    <div className='setheight'>
      <div className='mx-5 flex items-center justify-between my-8 shadow-2xl border border-gray-400 rounded-2xl p-4'>
        ...
        <h2 className="text-xl font-semibold dark:text-white">All Customers</h2>
        </div>
        <FaPlus onClick={()=>toggleForm()} className="text-2xl p-1 rounded-sm bg-blue-500 text-white dark:text-white mr-3"/>
      </div>
      ...
      ? data.customers.map(c => {
        return <div key={c._id} className={`rounded-xl flex justify-between items-center p-3 px-8 mx-5 my-3 relative overflow-hidden shadow-gray-500 transition-all hover:-translate-y-0.5 hover:shadow-lg dark:text-white dark:bg-gray-700 dark:border-gray-600 bg-gray-50 border-gray-400 border`}>
